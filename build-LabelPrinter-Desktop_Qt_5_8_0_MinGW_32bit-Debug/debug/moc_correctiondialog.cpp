/****************************************************************************
** Meta object code from reading C++ file 'correctiondialog.h'
**
...
#include "../../LabelPrinter/View/Dialog/correctiondialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'correctiondialog.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CorrectionDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CorrectionDialog_t qt_meta_stringdata_CorrectionDialog = {
    {
QT_MOC_LITERAL(0, 0, 16), // "CorrectionDialog"
QT_MOC_LITERAL(1, 17, 13), // "slotSaveClick"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "CorrectionDialog\0slotSaveClick\0"
};
...
const QMetaObject CorrectionDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CorrectionDialog.data,
      qt_meta_data_CorrectionDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CorrectionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CorrectionDialog.stringdata0))
